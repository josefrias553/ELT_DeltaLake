...
def get_data_full(url_f, endpoint_f, data_field = None, params_f = None, headers_f = None, intentos=3, espera=2):
    for i in range(intentos):
        try:
            ...
            print(f"Error al obtener datos: {e}")
            return sys.exit("Posible falta token o error en el token.")
    return None